...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Gallery artworks from students and instructor';
    displayName: 'Artwork';
    pluralName: 'artworks';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['student', 'instructor']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Art class events and workshops';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage content settings';
  ...
  attributes: {
    ...
    bannerTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Art Classes with Alevtyna'>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyChooseUsItems: Schema.Attribute.JSON;
  };
}
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer leads and orders';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
  ...
  attributes: {
    ...
    eventPrice: Schema.Attribute.Decimal;
    eventTime: Schema.Attribute.String;
    isSubscribed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logoDesktop: Schema.Attribute.Media<'images'>;
